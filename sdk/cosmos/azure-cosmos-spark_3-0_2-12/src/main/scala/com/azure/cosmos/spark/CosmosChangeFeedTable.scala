 ...
 * @param userConfig
 */
class CosmosChangeFeedTable(val transforms: Array[Transform],
  ...
  val clientConfig = CosmosAccountConfig.parseCosmosAccountConfig(
    CosmosConfig.getEffectiveConfig(userConfig.asScala.toMap))
  ...
  lazy val containerStateHandle : Broadcast[CosmosClientMetadataCachesSnapshot] =
  ...
  override def name(): String = "com.azure.cosmos.changefeed.spark.write"
