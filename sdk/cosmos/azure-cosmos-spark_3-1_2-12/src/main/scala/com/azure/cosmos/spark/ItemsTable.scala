...
private class ItemsTable(override val sparkSession: SparkSession,
                         ...
                         override val tableProperties: util.Map[String, String] = Collections.emptyMap[String, String])
  extends ItemsReadOnlyTable(sparkSession, transforms, databaseName, containerName, userConfig, userProvidedSchema, tableProperties)
  with SupportsWrite {
