...
class ChangeFeedQueryWithRequestOptionsImpl<T extends Resource> {
    ...
    public ChangeFeedQueryWithRequestOptionsImpl(
    ...
    public Flux<FeedResponse<T>> executeAsync() {
        ...
        final int maxPageSize = this.options.getMaxItemCount() != null ? options.getMaxItemCount(): -1;
